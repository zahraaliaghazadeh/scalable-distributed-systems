...
import consumer.listener.SkierListener;
...
public class SkierConsumer {
  ...
  private static final ConcurrentHashMap<String, List<LiftRide>> skierToLiftRides = new ConcurrentHashMap<>();
...
//    JedisPool jedisPool = new JedisPool("localhost", 6379);
  ...
  private static void startSqsConsumer(SQSConnectionFactory connectionFactory, JedisPool jedisPool) throws Exception {
    ...
    consumer.setMessageListener(new SkierListener(skierToLiftRides, jedisPool));
    connection.start();
  }
}
